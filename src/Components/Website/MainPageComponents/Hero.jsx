        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="banner-blocks">
              ...
              <div class="banner-ad bg-success-subtle block-2" style={{background:`url(${require("../images/ad-image-1.png")}) no-repeat`,backgroundPosition: "right bottom"}}>
                <div class="row banner-content p-5">
              ...
              <div class="banner-ad bg-danger block-3" style={{background:`url(${require("../images/ad-image-2.png")}) no-repeat`,backgroundPosition: "right bottom"}}>
                <div class="row banner-content p-5">
